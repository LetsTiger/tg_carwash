...
Citizen.CreateThread( function()
    updatePath = "/LetsTiger/tg_carwash"
    resourceName = "Carwash Script ("..GetCurrentResourceName()..")"
...
function Resourcestart()
    ...
    if rio then
        print("^4|▶ ^0[^1ERROR^0] ^1"..resourceName.." ist veraltet! Bitte updaten: https://github.com/LetsTiger/tg_carwash/        ^4|")
